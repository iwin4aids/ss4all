 ...
 */
@Component
public class IpAuthticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (stringAuthorities == null) {
            ...
            //封装权限信息，并且此时身份已经被认证
            return new IpAuthenticationToken(ip, AuthorityUtils.commaSeparatedStringToAuthorityList(stringAuthorities));
        }
    }
